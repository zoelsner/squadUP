                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // Make sure we have the default stuff in the database
                            Database.get().getUser(new Database.OnResultListener<User>() {
                                @Override
                                public void onResult(User user) {
                                    Intent startLauncherActivity = new Intent(LoginActivity.this, LauncherActivity.class);
                                    startActivity(startLauncherActivity);
